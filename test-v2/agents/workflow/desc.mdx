...
Agent de workflow principal

## Informations

- **Type**: `test-v2/workflow`
- **Auteur**: Test User
- **Version**: 1.0.0
...
- ✅ Structure simplifiée `agents/workflow/`
- ✅ Base de données globale `~/.directive/data/`
- ✅ Type d'agent: `test-v2/workflow`
...
```bash
directive deploy agent workflow
```
